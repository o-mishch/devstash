...
describe('POST /auth/login', () => {
  ...
  it('returns 400 for wrong credentials and consults the rate limiter', async () => {
  ...
  it('returns 429 when the limiter denies a failed login', async () => {
    const credError = new MockAuthError()
    credError.type = 'CredentialsSignin'
    mockSignIn.mockRejectedValue(credError)
  ...
  it('returns the typed 403 carrying the unverified email', async () => {
