"""gcp/app.py — the `devstash-infra gcp <cmd>` typer sub-app: the run.sh dispatch boundary.
...
from devstash_infra.gcp.apply_gate import require_state_bucket
...
from devstash_infra.gcp.tfvars import ensure_tfvars
