...
`minAvailable: 1` — під час *добровільних* збоїв (voluntary disruptions) (drain ноди для оновлення,
зменшення масштабу автоскейлером) Kubernetes не виселятиме (evict) pod'и нижче цієї межі. Захищає
від того, щоб drain поклав усі репліки одночасно.
