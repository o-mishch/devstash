...
# poll_until message hook — kept at module scope (reachable-by-name to shellcheck, no
# SC2317/SC2329 disable); the gap arrives as a forwarded msg_arg ($3) rather than a closed-over
# local. Mirrors ds_ar_wait's _ds_ar_wait_msg / check-env-active.sh's _cluster_wait_msg.
