...
- **Path-scoped** (load only when you touch matching files, via `paths:` frontmatter): `nextjs-architecture.md`, `database.md`, `security.md`, `testing.md`, `api-contract.md`, `infra.md`, `infra-shell.md`.
